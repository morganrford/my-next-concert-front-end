const ConcertDetail = (props) => {
    ...
    return (
        <div>
            ...
            <ul>
                <li>
                    Venue Name: {props.selectedConcert.venueName}
                </li>
                ...
                <li>Bands: {props.selectedConcert.bands.map(band => band.bandName).join(', ')}
</li>
            </ul>
             <button onClick={()=> props.handleConcertFormView(props.selectedConcert)}>Edit Concert</button>
            <button onClick={() => props.handleDeleteConcert(props.selectedConcert._id)}>Delete Concert</button>
        </div>
    )
}
